...
namespace Customer_Portal.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            var response = await client.GetAsync("https://rocket-elevators-rest-api-code.herokuapp.com/api/Customers/");
            var user_email = response.Content.ReadAsStringAsync().Result; 
            if (user_email.Contains(Input.Email))
            {
